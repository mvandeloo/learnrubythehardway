...
def puts_last_word(words)
    word = words.pop(0) #-1 geändert in 0, klammer dazu
    puts word
end

# Takes in a full sentence and returns the sorted words.
def sort_sentence(sentence)
    words = break_words(sentence) #function in function?
...
def puts_first_and_last(sentence)
    ...
    puts_first_word(words) #_
    puts_last_word(words) #_
end
